...
{
    public class EstadoOrdenProduccionEnImpresion : ControllerApp
    {
            ...
            using (ISession Sesion = m_SessionFactory.OpenSession())
            {
                using (ITransaction Trans = Sesion.BeginTransaction())
                {
                    ...
                    try
                    {
                        ...
                        Progreso.Start(Cps.Count, "Cambiando a IMPRESION a Ordenes de Produccion ...");
                        foreach (OrdenProduccion Cp in Cps)
                        {
                            ...
                            SqlCmd.Parameters.AddWithValue("@EstadoAprobacion", "EN IMPRESION");
