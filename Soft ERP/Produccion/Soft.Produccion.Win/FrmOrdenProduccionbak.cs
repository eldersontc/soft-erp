...
{
    public partial class FrmOrdenProduccionbak : FrmParent
    {
        public FrmOrdenProduccionbak()
        {
            InitializeComponent();
        }
        ...
        private void txtMedidaAnchoCaja_ValueChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ItemOrdenProduccion.MedidaAnchoCaja = Convert.ToDecimal(txtMedidaAnchoCaja.Value);
                //MostrarTotalServicio(ItemCotizacion);
            }
            catch (Exception ex)
            {
